...
import { Order, OrderPaymentStatusType } from '@/generated/prisma/client'
...
} satisfies OrderCanceledEmailProps

export default function OrderCanceledEmail({ order }: OrderCanceledEmailProps) {
  return (
    <Html>
      <Preview>Otkazana porudžbina</Preview>
      <Tailwind>
        <Head />
        <Body className='font-sans bg-white'>
          <Container className='max-w-xl'>
            ...
            <Section>
              ...
              <Text>
                Porudžbina pod brojem:{' '}
                <span className='font-semibold'>{order.orderNumber}</span> je
                otkazana. Ukoliko je niste Vi otkazali ili operater u skladu sa
                Vašim zahtevom molimo da nas kontaktirate, u suprotnom ne morate
                odgovarati i time smatramo da ste saglasni.
              </Text>
              <Text>
                <span className='font-semibold'>Važno:</span> Ukoliko je
                porudžbina otkazana greškom, a Vi ne odreagujete, porudžbina
                neće biti u izradi i samim tim je neće biti na isporuci. Ukoliko
                ste plaćanje porudžbine izvšili online, novac će Vam biti vraćen
                u roku od 15 dana.
              </Text>
              <Text>Zahvaljujemo se na ukazanom poverenju i razumevanju.</Text>
            </Section>
