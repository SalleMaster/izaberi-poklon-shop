...
} satisfies OrderReadyForPickupEmailProps
...
export default function OrderReadyForPickupEmail({
  ...
  return (
    <Html>
      <Preview>Porudžbina spremna za preuzimanje</Preview>
      <Tailwind>
        <Head />
          ...
          <Container className='max-w-xl'>
            ...
            <Section>
              ...
              <Text className='font-semibold'>
                Vaša porudžbina je spremna za preuzimanje.
              </Text>
              <Text>
                Porudžbina pod brojem:{' '}
                <span className='font-semibold'>{order.orderNumber}</span> je
                spremna za lično preuzimanje u našoj poslovnici u ulici Pavla
                Vujisića 12, Aranđelovac (
                <a
                  href='https://maps.app.goo.gl/ru48jMVzJVJQfJvi6'
                  target='_blank'
                  rel='noopener noreferrer'
                >
                  pogledajte na Google Maps
                </a>
                ). <br /> Možete je preuzeti svakog radnog dana od 08-16h ili
                subotom od 09-15h. Ako iz nekog razloga ipak želite slanje na
                Vašu adresu molimo Vas da nas o tome obavestite.
              </Text>
              <Text>
              ...
              <Text>Zahvaljujemo se na ukazanom poverenju.</Text>
            </Section>
