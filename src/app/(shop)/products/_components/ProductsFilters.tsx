...
export default function ProductsFilters() {
  ...
  const sortingOptions = [
    ...
    },
    {
      ...
      url: {
        pathname,
        query: createQueryString({
          addParams: [{ name: 'sortiranje', value: 'najniza-cena' }],
        }),
      },
      value: 'najniza-cena',
    },
    {
      ...
      url: {
        pathname,
        query: createQueryString({
          addParams: [{ name: 'sortiranje', value: 'najvisa-cena' }],
        }),
      },
      value: 'najvisa-cena',
    },
  ...
  return (
    <div
      ...
      className='space-y-4 md:space-y-0 md:flex md:space-x-4 items-center'
    >
